...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'djangocms_link_link', 'url', self.gf('django.db.models.fields.URLField')(max_length=600, null=True))

    def backwards(self, orm):

        # Changing field 'Link.url'
        db.alter_column(u'djangocms_link_link', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
